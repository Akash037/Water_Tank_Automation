...
void blynkAnotherDevice() // Here we will send HIGH or LOW once per second
{
  ...
  if (value) {
    bridge1.digitalWrite(0, HIGH);  // Digital Pin 9 on the second board will be set HIGH
    ...
    bridge1.digitalWrite(0, LOW); // Digital Pin 9 on the second board will be set LOW
